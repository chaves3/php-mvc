...
class PessoaDAO
{
    ...
    public function __construct()
    {
        ...
        $dsn = "mysql:host=localhost:3306;dbname=cadastro_equipamentos";
    ...
    public function insert(PessoaModel $model)
    {
        ...
        $sql = "INSERT INTO teste (nome, cpf, data_nascimento) VALUES (?, ?, ?) ";
    ...
    {
        $sql = "UPDATE teste SET nome=?, cpf=?, data_nascimento=? WHERE id=? ";
